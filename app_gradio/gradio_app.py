...
def render_result_cards_html(result: Dict, elapsed: float, model_choice: str) -> str:
    ...
    html = '<div style="display: flex; flex-wrap: wrap; gap: 20px; width: 100%; font-family: \'Inter\', sans-serif; margin-bottom: 10px;">'
...
def update_calculator(selected_class: str):
    ...
    metrics_html = f"""
    <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 15px; font-family: 'Inter', serif;">
